...
export default {
    ...
    data() {
        return {
            roleId: this.$props.dataEdit.role_id,
            namaRole: this. $props.dataEdit.role_name,
            deskripsiRole: this. $props.dataEdit.role_description
        }
    },
    ...
    methods:{
        updateData(){
            ...
            let config_update = {
                method: "put",
                url: process.env.VUE_APP_BACKEND_URL_API + 'roles/' + this.roleId,
                data: {
